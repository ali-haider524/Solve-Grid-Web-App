...
export const guides: GuideInfo[] = [
  ...
  { slug: "ti-84-style-graphing-workflows", title: "TI-84 style online problem-solving guide", summary: "Use independent online tools for scientific calculations, graphs, tables, equations, polynomial roots, matrices, statistics, and unit conversion.", toolSlugs: [ "scientific-calculator", "graphing-calculator", "equation-solver", "polynomial-solver", "matrix-calculator", "statistics-calculator", "unit-converter"] },
